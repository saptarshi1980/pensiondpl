...
public class FetchEmployeeServlet extends HttpServlet {
	...
	/*
	 * private static Map<String, Double> calculateYearlyOutflow(PayComponents
	 * initialPay, LocalDate retirementDate, PrintWriter logWriter, String empId,
	 * String empName, int incrementMonth) {
	 * 
	 * // Clear previous projections lastCalculatedProjections.clear();
	 * 
	 * Map<String, Double> yearlyOutflows = new LinkedHashMap<>(); double balance =
	 * 0; double monthlyInterestRate = 0.0825 / 12; double finalRetirementBalance =
	 * 0;
	 * 
	 * logWriter.println(
	 * "=============================================================================================================="
	 ...
	 * 
	 * // Initialize with the first available data PayComponents monthlyPay = new
	 * PayComponents(initialPay.getBasic(), initialPay.getDa());
	 * 
	 ...
	 * ); }
	 * 
	 * // Store December values for each year for projections if (month == 12) {
	 * lastCalculatedProjections.put(String.valueOf(year), new
	 * PayComponents(monthlyPay));
	 * //logWriter.println("Storing projection for December " + year + ": Basic=" +
	 * monthlyPay.getBasic() + ", DA=" + monthlyPay.getDa()); }
	 * 
	 ...
	 * 
	 * // Store retirement month projection if not December if (month != 12) {
	 * lastCalculatedProjections.put(String.valueOf(year), new
	 * PayComponents(monthlyPay));
	 * 
	 ...
	 * logWriter.println("\nExtracted year-wise projections:"); for
	 * (Map.Entry<String, PayComponents> entry :
	 * lastCalculatedProjections.entrySet()) { logWriter.println("Year " +
	 * entry.getKey() + ": Basic=" + entry.getValue().getBasic() + ", DA=" +
	 * entry.getValue().getDa()); }
	 * 
	...
	private static Map<String, Double> calculateYearlyOutflow(PayComponents initialPay, LocalDate retirementDate, 
		 ...
		 * "=============================================================================================================="
		 * ); logWriter.println("Employee ID: " + empId);
		 * logWriter.println("Employee Name: " + empName); logWriter.
		 * printf("EPFO Demand Amount / Opening PF Balance (as of April 2025): %,15.2f%n"
		 * , balance);
