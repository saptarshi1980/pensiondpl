...
<div class="mt-5">
    ...
    🧮 <strong>Approximate Company Contribution PF Outflow to be paid to EPFO <!-- - From Present Year to completion of your 58 years of age --> :</strong> ₹ <strong class="net-outflow"><%= (long) netOutflow %>(${netOutflowWords})</strong>
</div>
<% } else { %>
